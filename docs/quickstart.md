...
5. In **Agents**, create or select an Agent, then edit its identity or instructions. Creation starts at draft v1; saving creates another immutable version, publishing makes it embeddable, and the selected Agent persists across refreshes.
